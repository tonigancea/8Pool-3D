	...
	class CameraTema
	{
		public:
			...
			void RotateFirstPerson_OX(float angle)
			{
				...
				// Use glm::rotate()
				forward = glm::normalize(glm::vec3(glm::rotate(glm::mat4(1.f), angle, right) * glm::vec4(forward, 0)));
				up = glm::normalize(glm::vec3(glm::cross(right, forward)));
			}
			...
			void RotateFirstPerson_OY(float angle)
			{
				...
				// Use glm::rotate()
				forward = glm::normalize(glm::vec3(glm::rotate(glm::mat4(1.f), angle, glm::vec3(0, 1, 0)) * glm::vec4(forward, 0)));
			...
			void RotateFirstPerson_OZ(float angle)
			{
				...
				// Don't forget to normalize the vectors
				right = glm::normalize(glm::vec3(glm::rotate(glm::mat4(1.f), angle, forward) * glm::vec4(right, 0)));
				up = glm::normalize(glm::vec3(glm::rotate(glm::mat4(1.f), angle, forward) * glm::vec4(up, 0)));
